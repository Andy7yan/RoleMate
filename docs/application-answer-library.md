...
### Graduate / early-career permanent role

Default:

> AUD 85,000 base salary plus superannuation, negotiable based on the role scope and overall package.

Case selection:

| Situation | Recommended entry |
|---|---|
| One numeric field, base salary | `85000` |
| Range accepted | `AUD 80,000–90,000 base plus super` |
| Total package including super | Approximately `AUD 95,000 package` |
| Strong large-tech role such as AWS or TikTok | `AUD 90,000 base plus super, negotiable` or `Market-aligned / negotiable` |
| Standardised graduate program | `Aligned with the organisation's established graduate package` |
| High-paying trading firm such as Citadel or Optiver | `Negotiable and aligned with the established graduate compensation package` — avoid anchoring too low |

Do not normally enter less than AUD 75,000 for a Sydney software graduate role unless the role is unusually valuable for other reasons.

### Internship

Default:

> AUD 36 per hour plus superannuation, negotiable and aligned with the organisation's standard internship compensation.

Case selection:

| Situation | Recommended entry |
|---|---|
| One numeric hourly field | `36` |
| Range accepted | `AUD 35–40 per hour plus super` |
| Annualised salary required | `AUD 71,000` |
| Ordinary mid-sized software employer | `AUD 35–36 per hour plus super` |
| Strong technical company | `AUD 38–40 per hour plus super` |
| Standardised internship program | `Aligned with the organisation's established internship rate` |
| High-paying trading firm such as Citadel or Optiver | `Negotiable and aligned with the established internship compensation package` — do not anchor at the ordinary market rate |

Avoid quoting AUD 25–30 per hour for a software internship unless there is a specific reason. Avoid AUD 45+ per hour for an ordinary employer unless market evidence supports it.

## Notice period and availability

Current facts:

- Andy is currently studying and expects to complete degree requirements at the end of August 2026.
- Andy has no current employment or part-time job requiring notice.
...
> I do not have a notice period, as I am not currently employed. I am available to commence full-time work from 1 September 2026 after completing my degree requirements at the end of August. I may be available earlier for a part-time or internship arrangement that can be scheduled around my remaining university commitments.
